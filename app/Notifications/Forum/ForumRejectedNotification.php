...
class ForumRejectedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject("Forumda açtığın konu onaylanmadı !.")
            ->line("Forumda açtığın konu aşağıdaki sebeplerden dolayı onaylanmamış olabilir.")
            ->line(" >  Uygunsuz kelimeler içermesi.")
            ->line(" >  Bu konunun daha önce açılmış olması")
