        ...
        <div class="box-body with-border">
            <div class="row">
                <div class="col-md-10">
                    ...
                    › <a href="{{ route('admin.content') }}">@lang('admin.navbar.content_management')</a>
                    › {{ $item->title }}
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sayfa Detay</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="form-row">
                            ...
                            <x-input name="slug"
                                     label="Slug/Dosya Adı"
                                     width="12"
                                     placeholder="Boş bırakınız veya /views/site/content/static/ klasörü altında bulunan sadece dosya adını yazınız."
                                     :value="$item->slug"
                                     horizontal help="Eğer /views/site/content/static/{slug}.blade.php dosyası varsa o yüklenir yoksa varsayılan template yüklenir."
                            />
