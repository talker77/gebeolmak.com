    ...
    <div class="login-box-body">
        ...
        <form action="{{ route('admin.login') }}" method="POST">
            ...
            <div class="form-group has-feedback">
                <input type="email" class="form-control" placeholder="Email" name="email" value="{{ config('app.debug') ? config('admin.username') : '' }}">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" placeholder="Password" name="password" value="{{ config('app.debug') ? config('admin.password') : '' }}">
