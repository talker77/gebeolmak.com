                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            ...
                            @endif
                            @if($item->id)
                                  ---  <a href="{{ route('blog.detail',['blog' => $item->slug]) }}">Sitede Görüntüle : <i class="fa fa-eye"></i></a>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            ...
                            @if(admin('modules.blog.category'))
                                ...
                                <x-select
                                    name="type"
                                    horizontal
                                    help="Blog Nerede listelensin ?"
                                    label="Tür"
                                    :options="$types" width="12"
                                    :value="$item->type"
                                    key="key"
                                    nokey="1"
                                />
                            ...
                            @if(loggedAdminUser()->isSuperAdmin())
                                <x-select name="writer_id" label="Moderatör" width="12" :value="$item->writer_id" :options="$moderators" option-value="full_name" horizontal required/>
                            @endif
                            <x-input horizontal name="is_active" type="checkbox" label="Yayında Mı ?" width="12" :value="$item->is_active" class="minimal"/>
